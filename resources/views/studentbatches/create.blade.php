...
@section('content')
    ...
    <form action="{{ route('studentbatchs.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
        ...
        <div class="col-xs-6 col-sm-6 col-md-6">
            <div class="form-group">
                ...
                {!! Form::select('course_box',array("Select Course"),array('class' => 'form-control','single')) !!}   
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">         
                ...
                @endcan
                {!! Form::select('student_list[]',array("Choose university and department for pre populated student list"),[],array('class' => 'form-control','multiple','id'=>'student_list')) !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">                
                ...
                <STRONG>File Attachment (student certficate as single pdf)</STRONG>
                </label> 
